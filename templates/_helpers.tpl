...
*/}}
{{- define "nginx-hello-world.chart" -}}
...
helm.sh/chart: {{ include "nginx-hello-world.chart" . }}
...
*/}}
{{- define "nginx-hello-world.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nginx-hello-world.fullname" .) .Values.serviceAccount.name }}
{{- else }}
